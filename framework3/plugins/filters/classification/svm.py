...
class ClassifierSVMPlugin(BaseFilter, BasePlugin):
    ...
    @staticmethod
    def item_grid(C: List[float], kernel: List[L], gamma: List[float] | List[Literal['scale', 'auto']] = ['scale']) -> Dict[str, List[Any]]:
        """
        ...
        """
        return {'ClassifierSVMPlugin__C': C, 'ClassifierSVMPlugin__kernel': kernel, 'ClassifierSVMPlugin__gamma': gamma}