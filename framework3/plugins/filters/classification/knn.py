...
class KnnFilter(BaseFilter):
    ...
    def __init__(self, n_neighbors: int = 5, weights: Literal['uniform', 'distance'] = 'uniform', algorithm: Literal["auto", "ball_tree", "kd_tree", "brute"] = 'auto', 
                 leaf_size: int = 30, p: int = 2, metric: str = 'minkowski', 
                 metric_params: Optional[Dict[str, Any]] = None, n_jobs: Optional[int] = None):
        """
